...
scheduler.form_blocks.combo={
	render:function(e){
		...
		new_item = "";
		if (e.add_new) {
			new_item = '<div style="text-align: center"><input id="new_item_btn_' + e.map_to + '" class="btn btn-primary" style="color:#fff" type="button" onclick="add_item(\'' + e.map_to + '\')" value="Nuevo" name="new_item_btn_' + e.map_to + '"><input id="new_' + e.map_to +'" value="" type="hidden"></div>';
			
		}
		return t+="<div class='"+e.type+"' style='height:"+(e.height||20)+"px;' ></div>" + new_item},
...
n.disable(1),n.selectOption(0),n.disable(0)}):n.setComboValue("")}else{for(var l=[],d=0;d<i.options.length;d++){var o=i.options[d],s=[o.key,o.label,o.css];l.push(s)}if(n.addOption(l),a[i.map_to]){var _=n.getIndexByValue(a[i.map_to]);n.selectOption(_)}}},

get_value:function(e,t,a){var i=e._combo.getSelectedValue();return a.script_path&&(a.cached_options[i]=e._combo.getSelectedText()),i},
...
scheduler.form_blocks.radio={render:function(e){var t="";t+="<div class='dhx_cal_ltext dhx_cal_radio' style='height:"+e.height+"px;' >";
